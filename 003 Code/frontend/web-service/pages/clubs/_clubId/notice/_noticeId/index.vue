    ...
    methods: {
      ...
      async getComments() {
        try {
          ...
          await this.$axios
            .get(
              `/notice-service/clubs/${this.$route.params.clubId}/posts/${this.$route.params.noticeId}/comments`,
              config
            )
            .then((res) => {
              console.log(res);
      ...
      async deleteNotice() {
        const confirmDelete = confirm("공지사항을 삭제하시겠습니까?");
        if (confirmDelete) {
          try {
            const access_token = this.$store.state.access_token;
            const config = {
      ...
      async deleteComment(postId) {
        ...
        if (confirmDelete) {
          try {
            ...
            await this.$axios
              .delete(
                `/notice-service/clubs/${this.$route.params.clubId}/posts/${this.$route.params.noticeId}/comments/${postId}`,
                config
              )
              .then(async (res) => {
                console.log(res);
      ...
      async updateComment(commentId) {
        try {
          ...
          await this.$axios
            .patch(
              `/notice-service/clubs/${this.$route.params.clubId}/posts/${this.$route.params.noticeId}/comments/${commentId}`,
