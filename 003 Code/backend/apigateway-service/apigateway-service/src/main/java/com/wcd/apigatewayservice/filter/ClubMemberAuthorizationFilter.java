...
@Component
@Slf4j
public class ClubMemberAuthorizationFilter extends AbstractGatewayFilterFactory<ClubMemberAuthorizationFilter.Config> {
    ClubServiceClient clubServiceClient;

    public ClubMemberAuthorizationFilter(@Lazy ClubServiceClient clubServiceClient) {
        super(Config.class);
