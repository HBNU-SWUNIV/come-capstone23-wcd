...
## 제목: MSA를 적용한 클라우드 기반 온라인 소셜 네트워크 플랫폼
...
- ### 필요성
  ...
  - 지역별 모임 활성화도 정도의 차이가 있어 수도권 및 광역권을 제외한 지역에서는 모임을 찾는 것조차도 어려운 경우우가 많아, 모임 활동을 하고 싶어도 할 수 없는 상황이다.
